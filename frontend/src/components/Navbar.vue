...
<template>
  <nav
    class="navbar px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 flex justify-between border-b-black-200 w-full py-2 shadow-md relative"
  >
    ...
    <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
      <ul class="flex gap-2 lg:gap-4 text-neutral">
        ...
        <li>
          <RouterLink
            ...
            to="/register"
            class="itbms-register-button block w-full"
            >Register</RouterLink
          >
        </li>
      ...
      <div class="flex gap-2 lg:gap-4 text-neutral">
        <Icon
          ...
          class="text-xl lg:text-2xl transition duration-300 hover:opacity-50"
        />
    ...
    >
      <div class="px-4 py-3 relative">
        <Icon
          icon="hugeicons:search-02"
          class="absolute left-7 top-1/2 transform -translate-y-1/2 text-gray-500"
        />
        <input
          type="text"
          placeholder="Search"
      ...
      <ul class="px-4 py-2">
        ...
        <li class="py-2 border-b border-gray-100">
          <RouterLink @click="isMobileMenuOpen = false" to="/" class="block w-full"
            >Home</RouterLink
          >
        </li>
        <li class="py-2 border-b border-gray-100">
          <RouterLink @click="isMobileMenuOpen = false" to="/sale-items" class="block w-full"
            >Gallery</RouterLink
          >
        </li>
      </ul>
