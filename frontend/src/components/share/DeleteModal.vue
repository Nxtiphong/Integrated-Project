      ...
      <div v-if="modelValue" class="fixed inset-0 z-50 overflow-y-auto" @click.self="cancel">
        <div class="flex min-h-screen items-center justify-center p-4 text-center">
          ...
          >
            ...
            <div class="mt-3">
              <p class="itbms-message text-center text-sm text-gray-500">
                {{ message }}
              </p>
            </div>
            ...
            <div class="mt-5 flex justify-center gap-3">
              <button
                type="button"
                class="itbms-cancel-button inline-flex justify-center cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                @click="cancel"
              >
                {{ cancelButtonText }}
              </button>
