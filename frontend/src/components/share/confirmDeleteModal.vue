          ...
          <div class="flex min-h-screen items-center justify-center p-4 text-center">
            ...
            >
              ...
              <div class="mt-5 flex justify-center gap-3">
                <button
                  type="button"
                  class="itbms-cancel-botton inline-flex justify-center cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  @click="cancel"
                >
                  {{ cancelButtonText }}
                </button>
                <button
                  type="button"
                  class="itbms-confirm-botton inline-flex cursor-pointer justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                  @click="confirm"
                >
                  {{ confirmButtonText }}
                </button>
